...
function PrimaryAction({ disabled = false, label, onClick }: { disabled?: boolean; label: string; onClick: () => void }) { return <button className="fixed inset-x-5 bottom-7 mx-auto flex h-14 w-[calc(100%-40px)] max-w-[350px] items-center justify-center rounded-2xl bg-[var(--tm-action-primary)] text-lg font-medium text-white disabled:opacity-50" disabled={disabled} onClick={onClick} type="button">{label}</button>; }
