...
flowchart TD
    ...
    C --> D["사업자·테니스장 정보 입력"]
    D --> E["사업자·주소·장소 자동 확인"]
    E -->|사업자 확인 완료| F["비공개 코트·시간대 초안 작성 가능"]
    E -->|전체 자동 조건 충족| H["공개 승인·운영자 홈"]
    E -->|장소 불일치·중복·운영 주체 확인 필요| G["검토 필요"]
    E -->|외부 확인 불가| I["자동 재시도 후 검토·수정 안내"]
    F --> J["공개 조건 자동 판정 또는 운영 검토"]
    J -->|승인| H
    G -->|정보 수정·증빙 보완| E
    G -->|운영 검토 승인| H
    G -->|반려| K["사유 확인·정정 후 재신청"]
    I -->|재시도 성공| E
```
