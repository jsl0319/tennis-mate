...
| `ALLOCATED` | 시간·가격·코트·정원·이용 안내 직접 수정 불가. 연결된 세션 보기 또는 운영상 문제 접수 |
...
- 세션 모집자가 시작 전 Match를 취소했을 때 Slot을 다시 열지, 새 초안만 허용할지
...
| 세션 모집자 또는 운영자 취소 | 이미 수락된 참가자는 갈 곳을 잃고, 운영자는 빈 시간을 다시 공급하지 못할 수 있음 | 운영자 철회는 긴급 사유 코드·상태 이력·연결 Match 취소·인앱 안내로만 처리. 반복 철회 시 새 공개 자동 중지 | 세션 모집자 취소 후 재공개, 외부 긴급 알림·보상/문의 절차 |
