...
서비스 내 채팅은 모든 Match의 유일한 연락 수단인 Match Chat MVP다. 범용 메신저·개인 DM·사진·파일·음성·읽음·접속·입력 중 표시는 제공하지 않는다. 상세 정책·보관·신고·운영 방식은 `08-in-app-match-chat-design.md`를 따른다.
...
| CORE-03 | 매칭 성사 후 연락 | 모든 Match에서 모집자와 ACCEPTED 신청자만 같은 Match의 서비스 내 텍스트 방 사용 |
| CORE-04 | 성별 및 연령 | 수집하지 않음 |
| CORE-05 | 코트 미정 매칭 | 일정·활동 지역·모집 정보로 생성. 수락자 전용 서비스 내 Match 방에서 코트·비용을 조율 |
