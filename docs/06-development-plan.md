...
| D-03 | 매칭 후 연락 | 모든 Match는 모집자와 수락자만 입장하는 서비스 내 텍스트 방 사용. 외부 오픈채팅 링크는 저장·반환하지 않음 |
...
- 범용 실시간 채팅, 개인 DM, 파일·사진·음성 메시지, 읽음·접속·입력 중 표시
- 영상 업로드와 AI 분석
- NTRP 자동 계산
- 클럽·커뮤니티·대회·랭킹
- 복잡한 AI 추천
...
개인 DM, 파일·사진·음성 메시지, 읽음·접속·입력 중 표시, 사용자 간 영구 차단은 이 단계에 포함하지 않는다.
